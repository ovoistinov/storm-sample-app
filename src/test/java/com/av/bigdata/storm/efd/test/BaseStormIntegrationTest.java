...
/**
 * The class defines default implementation of the <code>LocalCluster</code> initialization and shut down. It also
 * provides workaround for not deleted ZooKeeper log file from default java temp directory when shutting down cluster on
 * Windows. This is a known bug (TODO provide link to bug description)
 * 
 * @author avoistinov
 * @date 30.11.2012
 */
